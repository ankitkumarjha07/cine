...
import { Eye, Bookmark, Ghost, Fingerprint, Hexagon } from 'lucide-react';
...
const Home = () => {
    ...
    return (
        // Changed to h-[100dvh] for better iOS/iPad Safari support
        <div className="h-[100dvh] bg-black text-white flex flex-col font-sans overflow-hidden selection:bg-yellow-500/30">
        
        {/* Top Fade Overlay to protect the logo from scrolling overlap */}
        ...
        {activeTab === 'home' && (
            <motion.div 
                ...
                // THE FIX: Flex container that stretches and distributes space naturally
                className="absolute inset-0 flex flex-col px-6 pt-[31vh] pb-32 overflow-y-auto hide-scrollbar z-20" 
            >
                {/* Flex-1 forces this box to center itself in whatever space is left */}
                ...
                {/* EXPERT COPYWRITING & AESTHETIC FOOTER */}
                <div className="mt-12 shrink-0 flex flex-col items-center text-center opacity-40 hover:opacity-100 transition-all duration-700 cursor-default group pb-8">
                    ...
                    <span className="text-[8px] font-bold uppercase tracking-[0.4em] text-white mb-2">
                    ...
                    <button 
                        ...
                        className="mt-5 text-[8px] uppercase tracking-[0.3em] text-red-500/40 hover:text-red-500 transition-colors"
                    >
                        Erase Vault
                    </button>
                </div>
        ...
        <div className="fixed bottom-8 left-1/2 -translate-x-1/2 z-[100] w-[90%] max-w-[20rem] flex justify-center pointer-events-none">
